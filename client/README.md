...
Base: one mark is awarded for each API call that is completed -- demonstrated by the text above being successfully output to the console --, with 3/3 scoring 100% for the assessment. For students who finish before the allotted time, extra credit can be earned by addressing the issues noted in the code comments, and those in the 'extra credit' section below.
